import Report.AllureTestWatcher;
...
public class FormTest {
    ...
    void setUp(TestInfo testInfo) throws Exception {
        ...
        ScreenRecorderUtil.startRecording(testInfo.getDisplayName());
    }
    ...
    void tearDown() throws Exception {
        ...
        System.out.println("Recording saved to: " + ScreenRecorderUtil.getRecordingPath());
        String recordingPath = ScreenRecorderUtil.getRecordingPath();
        EmailSender.sendEmailWithAttachment(
                "EstiRockmill@gmail.com.com",
                "הקלטת טסט: testLogin",
                "the project run and success",
                recordingPath
        );
    }
    @Test
